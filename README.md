...
UUDET MODIT KÄYTTÖÖN 20.4. alkaen: | VANHAT MODIT, JOS OLET ASENTANUT PELIN ENNEN HUHTIKUUTA 2020: 
--- | --- 
...
* Kertausta: palaa takaisin Welcome to the Creative Mods -sivulle ja tee ”Platformer Microgame” -modit. Huom: Uuden pelipohjan lataaminen: https://learn.unity.com/tutorial/welcome-to-the-creative-challenges 
  * Linkki peliin julkaistaan GitHubissa: Eduvantaa/Unity/Platformer/README.md (esim. https://connect.unity.com/p/miran-tasohyppely). Modeja tehtäessä, tallenna pelin päivitetty, käännetty, versio edellisen päälle. Modeja on yhteensä 12kpl.  
